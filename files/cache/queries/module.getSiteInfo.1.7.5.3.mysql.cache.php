...
${'site_srl90_argument'} = new ConditionArgument('site_srl', $args->site_srl, 'equal');
${'site_srl90_argument'}->checkNotNull();
${'site_srl90_argument'}->createConditionValue();
...
new ConditionGroup(array(
new ConditionWithArgument('`sites`.`site_srl`',$site_srl90_argument,"equal")))
));
